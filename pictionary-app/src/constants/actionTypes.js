...
export const HANDLE_NEW_ROUND = 'HANDLE_NEW_ROUND';
export const HANDLE_SELECTED_WORD = 'HANDLE_SELECTED_WORD';
export const HANDLE_SCORE_UPDATE = 'HANDLE_SCORE_UPDATE';
export const HANDLE_GAME_OVER = 'HANDLE_GAME_OVER';
