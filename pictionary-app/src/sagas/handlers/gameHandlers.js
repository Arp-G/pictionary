...
import { ADD_ALERT, UPDATE_CANVAS, ADD_MESSAGE } from '../../constants/actionTypes';
import { WS_START_GAME, WS_CANVAS_UPDATE, WS_SEND_MESSAGE } from '../../constants/websocketEvents';
...
export function* handleCanvasUpdated(action) {
  yield put({ type: UPDATE_CANVAS, payload: action.payload });
}

export function* handleNewMessage(action) {
